...
Options:
  ...
  --x86_64-only              Use only fedora-43/44/45/rawhide x86_64 chroots
  --aarch64-only             Use only fedora-43/44/45/rawhide aarch64 chroots
...
while [[ $# -gt 0 ]]; do
  case "$1" in
    ...
    --x86_64-only)
      ...
      ;;
    --aarch64-only)
      chroots=(fedora-43-aarch64 fedora-44-aarch64 fedora-45-aarch64 fedora-rawhide-aarch64)
      explicit_chroots=1
      shift
      ;;
    --chroot)
