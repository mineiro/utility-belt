...
Options:
  ...
  --release <NN|rawhide>     Fedora release: 43, 44, 45, rawhide (repeatable)
...
is_valid_release() { case "$1" in 43|44|45|rawhide) return 0;; *) return 1;; esac; }
...
if [[ ${release_set} -eq 0 ]]; then releases=(43 44 45 rawhide); fi
